...
const MeetingRoom = () => {
  ...
  // Initialize Socket.IO server when component mounts
  useEffect(() => {
  ...
  const meetingTitle =
    call?.state?.custom?.description || 'Nexus Meet Conference';
          ...
          <div className="inset-x-0 bottom-0 z-50 bg-gradient-to-t from-black/80 to-transparent pb-6 pt-8">
            <div className="meeting-controls flex w-full items-center justify-center gap-3 px-4">
              ...
              <button
                ...
                title="Toggle Chat"
                className={cn(
                  'cursor-pointer rounded-2xl border border-white/20 px-4 py-3 shadow-lg backdrop-blur-md transition-all duration-300',
                  showChat
              ...
              <button
                ...
                className={cn(
                  'cursor-pointer rounded-2xl border border-white/20 px-4 py-3 shadow-lg backdrop-blur-md transition-all duration-300',
                  showTranscription
                    ? 'to-red-1 bg-gradient-to-r from-orange-1'
                    : 'to-red-1/80 hover:to-red-1 bg-gradient-to-r from-orange-1/80 hover:from-orange-1'
                )}
              >
              ...
              <DropdownMenu>
                <div className="flex items-center">
                  <DropdownMenuTrigger className="cursor-pointer rounded-2xl border border-white/20 bg-gradient-to-r from-blue-1/80 to-purple-1/80 px-4 py-3 shadow-lg backdrop-blur-md transition-all duration-300 hover:from-blue-1 hover:to-purple-1">
